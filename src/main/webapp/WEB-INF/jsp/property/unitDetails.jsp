...
<body>
	...
	<p>
		<img
			src="<c:url value="/resource/images/${unit.photoName}.png"></c:url>"
			alt="image" style="width: 350px" />
	</p>
	<p>
		<a href=" <spring:url value="/property/addlease/${unit.unitId}" /> "
			class="btn btn-primary"> <span
			class="glyphicon-info-sign glyphicon" /></span> Add Lease
		</a> <a href=" <spring:url value="/property/unitLease/${unit.unitId}" /> "
			class="btn btn-primary"> <span
			class="glyphicon-info-sign glyphicon" /></span> View Unit Lease
		</a> <a href=" <spring:url value="/property/unitView/${unit.unitId}" /> "
			class="btn btn-primary"> <span
